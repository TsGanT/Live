...
class PoopPacketType(PacketType):       # 继承PacketType，也许可以算作是重写？
...
class ShutdownPacket(PoopPacketType):       #Now all the packets have hash value，which means reliable connection
...
class POOP(StackingProtocol):
    ...
    def connection_made(self, transport):
        ...
        self.loop = asyncio.get_event_loop()    #creat an event loop
