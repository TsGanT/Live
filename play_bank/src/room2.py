...
# You are in another locked room. There is only one door and it is locked. Above the door there is a clock that reads {clock_time}.
# Across from the door is a large {mirror}. Below the mirror is an old charge. The room is old and musty and the floor is creaky and wraped.{interesting}
