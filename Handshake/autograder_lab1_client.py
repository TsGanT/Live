            ...
            if self.state == "test_start" and packet.submit_status == packet.PASSED:
                ...
                if isinstance(packet, autograder_packets.AutogradeClientCommand):
                    ...
                    f.add_done_callback(self.test_complete)
                                ...
                                autograder_packets.AutogradeTestStatus) and packet.client_status == packet.PASSED:
                ...
                if isinstance(packet, autograder_packets.AutogradeServerCommand):
                    ...
                    f.add_done_callback(self.test_complete)
                                ...
                                autograder_packets.AutogradeTestStatus) and packet.server_status == packet.PASSED:
                    self.state = "done"
...
if __name__ == "__main__":
    ...
    coro = playground.create_connection(lambda: Lab1AutogradeClient(server_addr, test_type, mode), host=server_addr,
                                        port=19101)
